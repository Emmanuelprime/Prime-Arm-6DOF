...
def main():
    ...
    try:
        ...
        robot.send_command({
            ...
            's': 45,   # Shoulder to 45 degrees
            'e': 90,   # Elbow to 90 degrees
            'w': 60,   # Wrist to 60 degrees
            't': 45,   # Twist to 45 degrees
        ...
        # Example 3: Check current angles before next move
        print("\n\n=== Test 3: Check angles and move ===")
        current = robot.get_current_angles()
        print(f"Current angles before move: {current}")
        ...
        # Example 4: Direct movement without stepping (instant)
        print("\n\n=== Test 4: Direct movement (no stepping) ===")
        robot.send_command({
            'w': 90,
            't': 0
        }, smooth=False, display_progress=False)
        print("Moved directly to w:90, t:0")
